            ...
            <div className='flex items-center md:order-2 space-x-2 md:space-x-0 rtl:space-x-reverse'>
              {user ? (
                ...
                <Link
                  type='button'
                  to='/login'
                  className='hidden md:block text-white bg-gradient-to-br from-green-400 to-blue-600 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-green-200 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center'>
                  <button>Login</button>
                </Link>
              )}
              <button
